/*! Summernote v0.8.2 | (c) 2013-2015 Alan Hong and other contributors | MIT license */ ! function(a) {
    ...
    var Renderer = function(a, b, c, d) {
        ...
        editor = renderer.create('<div class="note-editor note-frame panel panel-default" id="my_summernote_frame" />'),
        toolbar = renderer.create('<div class="note-toolbar panel-heading"/>'),
        editingArea = renderer.create('<div class="note-editing-area"/>'),
        codable = renderer.create('<textarea id="summernote_textarea" class="note-codable"/>'),
        editable = renderer.create('<div class="note-editable panel-body" id="summernote_content" contentEditable="true"/>'),
