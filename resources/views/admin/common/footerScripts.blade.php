...
<script type="text/javascript" src="{{asset(ADMIN_FILE_PATH.'/vendor/bootstrap4/js/bootstrap.min.js')}}"></script>
...
<script type="text/javascript" src="{{asset(ADMIN_FILE_PATH.'/vendor/flot/jquery.flot.min.js')}}"></script>
<script type="text/javascript" src="{{asset(ADMIN_FILE_PATH.'/vendor/flot/jquery.flot.resize.min.js')}}"></script>
<script type="text/javascript" src="{{asset(ADMIN_FILE_PATH.'/vendor/flot.tooltip/js/jquery.flot.tooltip.min.js')}}"></script>
<script type="text/javascript" src="{{asset(ADMIN_FILE_PATH.'/vendor/CurvedLines/curvedLines.js')}}"></script>
<script type="text/javascript" src="{{asset(ADMIN_FILE_PATH.'/vendor/TinyColor/tinycolor.js')}}"></script>
<!-- <script type="text/javascript" src="{{asset(ADMIN_FILE_PATH.'/vendor/sparkline/jquery.sparkline.min.js')}}"></script> -->
<script type="text/javascript" src="{{asset(ADMIN_FILE_PATH.'/vendor/raphael/raphael.min.js')}}"></script>
<script type="text/javascript" src="{{asset(ADMIN_FILE_PATH.'/vendor/morris/morris.min.js')}}"></script>
<script type="text/javascript" src="{{asset(ADMIN_FILE_PATH.'/vendor/jvectormap/jquery-jvectormap-2.0.3.min.js')}}"></script>
<script type="text/javascript" src="{{asset(ADMIN_FILE_PATH.'/vendor/jvectormap/jquery-jvectormap-world-mill.js')}}"></script>
<script type="text/javascript" src="{{asset(ADMIN_FILE_PATH.'/vendor/peity/jquery.peity.js')}}"></script>
<script type="text/javascript" src="{{asset(ADMIN_FILE_PATH.'/vendor/font-awesome/js/font-awesome.min.js')}}" ></script>
