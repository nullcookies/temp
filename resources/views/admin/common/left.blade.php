<div class="site-sidebar">
				<div class="custom-scroll custom-scroll-light">
					<ul class="sidebar-menu">
					    ...
					    <li>
							<a href="{{url('/')}}" target="_blank" class="waves-effect  waves-light">
								<span class="s-icon"><i class="fa fa-television"></i></span>
								<span class="s-text">Visit Website</span>
							</a>
						</li>
						<li>
							<a href="{{url('/admin')}}" class="waves-effect  waves-light">
						...
						<li>
							<a href="{!! url(ADMIN_URL_PATH.'/website-analytics') !!}" class="waves-effect  waves-light">
						...
						<li>
							<a href="{!! url(ADMIN_URL_PATH.'/homepage/nav') !!}" class="wave-effect waves-light">
						...
						<li>
							<a href="{{url('/admin/homepage_category')}}" class="waves-effect  waves-light">
								<span class="s-icon"><i class="fa fa-tachometer"></i></span>
						...
						<li>
									<a href="{!! url(ADMIN_URL_PATH.'/orders/view') !!}" class="waves-effect  waves-light">
										<span class="s-icon mr-10"><i class="fa fa-shopping-cart"></i></span>
										<span class="s-text">View Orders</span>
									</a>
								</li>
								<li>
							<a href="{!! url(ADMIN_URL_PATH.'/orders/manifest') !!}" class="waves-effect  waves-light">
								<span class="s-icon mr-10"><i class="fa fa-file-text"></i></span>
								<span class="s-text">Generate Menifest</span>
							</a>
						</li>
						<li>
							<a href="{!! url(ADMIN_URL_PATH.'/orders/orderDispatch') !!}" class="waves-effect  waves-light">
						...
						<li>
							<a href="{!! url(ADMIN_URL_PATH.'/orders/returnorder') !!}" class="waves-effect  waves-light">
								<span class="s-icon mr-10"><i class="fa fa-undo"></i></span>
								<span class="s-text"> Initiate Return</span>
							</a>
						</li>
						<li class="">
							<a href="{!! url(ADMIN_URL_PATH.'/orders/return') !!}" class="waves-effect  waves-light">
						...
						<li class="">
							<a href="{!! url(ADMIN_URL_PATH.'/product') !!}" class="waves-effect  waves-light">
								<span class="s-icon"><i class="fa fa-dropbox"></i></span>
								<span class="s-text">Products</span>
							</a>
						</li>
						<li class="">
							<a href="{!! url(ADMIN_URL_PATH.'/product/upload') !!}" class="waves-effect  waves-light">
								<span class="s-icon"><i class="fa fa-spinner"></i></span>
								<span class="s-text">Add Products</span>
							</a>
						</li>
						<li class="">
							<a href="{{url(ADMIN_URL_PATH.'/product/inventory')}}" class="waves-effect  waves-light">
						...
						<li class="">
							<a href="{!! url(ADMIN_URL_PATH.'/product/deleted') !!}" class="waves-effect  waves-light">
						...
						<li class="">
							<a href="{!! url(ADMIN_URL_PATH.'/category') !!}" class="waves-effect  waves-light">
						...
						<li class="">
							<a href="{!! url(ADMIN_URL_PATH.'/coupon#left_coupon_tab') !!}" id="left_coupon_tab" class="waves-effect  waves-light">
								<span class="s-icon"><i class="fa fa-ticket"></i></span>
								<span class="s-text">Coupons</span>
							</a>
						</li>
						<li class="compact-hide">
							<a href="{!! url(ADMIN_URL_PATH.'/user_management') !!}" class="waves-effect  waves-light">
