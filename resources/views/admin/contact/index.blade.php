		...
		<div class="row row-sm">
				...
				<div class="box box-block bg-white">
					<div class="row">
						<div class="col-md-4 col-sm-4 text-center">
							<img class="img-fluid b-a-radius-circle" src="{{url('lteadmin/img/avatars/customercare.png')}}" alt="">
						</div>
			...
			<div class="col-md-4">
				<div class="box box-block bg-white">
					<div class="row">
						<div class="col-md-4 col-sm-4 text-center">
							<img class="img-fluid b-a-radius-circle" src="{{url('lteadmin/img/avatars/logistic.png')}}" alt="">
						</div>
						<div class="col-md-8 col-sm-8">
							<h5>Logistics</h5>
							<p>
			...
			<div class="col-md-4">
				<div class="box box-block bg-white">
					<div class="row">
						<div class="col-md-4 col-sm-4 text-center">
							<img class="img-fluid b-a-radius-circle" src="{{url('lteadmin/img/avatars/accounts.png')}}" alt="">
						</div>
						<div class="col-md-8 col-sm-8">
							<h5>Accounts</h5>
							<p>
		...
		<div class="row row-sm">
			<div class="col-md-4">
				<div class="box box-block bg-white">
					<div class="row">
						<div class="col-md-4 col-sm-4 text-center">
							<img class="img-fluid b-a-radius-circle" src="{{url('lteadmin/img/avatars/training.png')}}" alt="">
						</div>
						<div class="col-md-8 col-sm-8">
							<h5>Training</h5>
							<p>
			...
			<div class="col-md-4">
				<div class="box box-block bg-white">
					<div class="row">
						<div class="col-md-4 col-sm-4 text-center">
							<img class="img-fluid b-a-radius-circle" src="{{url('lteadmin/img/avatars/marketing.png')}}" alt="">
						</div>
						<div class="col-md-8 col-sm-8">
							<h5>Marketing</h5>
							<p>
			...
			<div class="col-md-4">
				<div class="box box-block bg-white">
					<div class="row">
						<div class="col-md-4 col-sm-4 text-center">
							<img class="img-fluid b-a-radius-circle" src="{{url('lteadmin/img/avatars/ceo.png')}}" alt="">
						</div>
						<div class="col-md-8 col-sm-8">
							<h5>CEO</h5>
							<p>
