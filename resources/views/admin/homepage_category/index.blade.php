...
<div class="content-area py-1">
	<div class="container-fluid">
		<h4>Upload Homepage Category</h4>
		<div class="box-block bg-white">
			...
			<div class="form-group row">
				...
				<div class="col-sm-12">
					<input type="text" class="form-control" value="{{Old('title')}}" id="subject" name="title" placeholder="Album Name">
			...
			<div class="form-group row">
				<label for="subject" class="col-sm-2 col-form-label">link Title</label>
				<div class="col-sm-12">
					<input type="text" class="form-control" value="{{Old('link_title')}}" id="subject" name="link_title" placeholder="Album Name">
					@if($errors->has('link_title')) <span class="text-danger">{{ $errors->first('link_title') }} </span>@endif
				</div>
			</div>
