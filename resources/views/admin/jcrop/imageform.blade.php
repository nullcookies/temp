...
<script src="https://code.jquery.com/jquery-1.12.4.min.js"></script>
  ...
  <script>
      ...
      if(isset($producthotdeal)){ ?>
        ...
        var imagename = "{{ $img }}";
        var name = "{{$name}}";
        var producthotdeal = "{{ $producthotdeal }}";
        var rating = "{{ $rating }}";
  ...
  <div class="row">
      <div class="col-md-9">
        ...
        <div class="img-container">
          <img src="{!! url($imgpath. '/img/',[$img]) !!}" alt="Picture">
        </div>
      </div>
      <div class="col-md-3">
    ...
    <!--<div class="row docs-actions">
        ...
        <div class="modal fade docs-cropped" id="getCroppedCanvasModal" aria-hidden="true" aria-labelledby="getCroppedCanvasTitle" role="dialog" tabindex="-1">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              {!! Form::open(array('method' => 'get', 'action' => ['Admin\WebsiteSetting\WebsiteSettingController@savejcrop'])) !!}
      ...
      <!--<div class="col-md-3 docs-toggles">
        ...
        <label class="btn btn-primary active" data-method="setAspectRatio" data-option="{!! ($w/$h) !!}" title="Set Aspect Ratio">
            <input type="radio" class="sr-only" id="aspestRatio0" name="aspestRatio" value="{!! ($w/$h) !!}">
            <span class="docs-tooltip" data-toggle="tooltip" title="$().cropper(&quot;setAspectRatio&quot;, {!! $w/$h !!})">
              4:3
            </span>
          </label>
        ...
        <a class="btn btn-default btn-block " href="{{url('/cropper/docs')}}" data-toggle="tooltip" target="_blank" title="Cropper without jQuery">Go to CropperJS</a>
