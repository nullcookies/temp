				...
				<table class="table table-striped">
					...
					<tr>
						...
						<td colspan="4">
							...
							@foreach($order->products as $product)
								<tr>
									...
									<td style="width:58%">{{ $product->product_name }}</td>
									<td style="width:12%">{{ $product->selling_price }}</td>
						...
						<td id="action{!! $order->id !!}">											
							<a href="javascript:" onclick="changeStatus({!! $order->id !!},'return')" class="btn btn-success btn-rounded mb-0-25 waves-effect waves-light" title="Mark Completed">Mark Return</a>						
