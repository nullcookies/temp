					...
					<tbody id="ressult">									
						...
						<td colspan="4">
							...
							@foreach($order->products as $product)
								<tr>
									<td style="width:14%">{{ $product->product_id }}</td>
									<td style="width:59%">{{ $product->product_name }}</td>
						...
						<td id="action{!! $order->id !!}">											
							<a href="javascript:" onclick="changeStatus({!! $order->id !!},'delivered')" class="btn btn-success btn-rounded mb-0-25 waves-effect waves-light" title="Delivered">Delivered</a>							
						</td>
					</tr>
					@endforeach
				</tbody>
