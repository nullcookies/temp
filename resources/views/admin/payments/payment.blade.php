							...
							<table class="table table-striped">
								...
								<tbody>
									<tr ng-repeat = "reff in reffVal">
										...
										<td><a href="{{route('details')}}/[[reff.refrerence_no]]" target="_new">[[reff.refrerence_no]]</a></td>
										<td>[[reff.commision_amount]]</td>
										<td>[[reff.date]]</td>
										<td><a href="{{route('dounload_csv')}}/[[reff.refrerence_no]]"><i class="fa fa-download"></i></a></td>
									</tr>
									
								</tbody>
								<tfoot>
									<tr>
										<td colspan="5"><a href="{{route('view_all_from_reff_cntrl')}}">View All Notifications</a></td>
									</tr>
								</tfoot>
							</table>
