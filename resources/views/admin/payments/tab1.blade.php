...
@section('content')
				<div class="container-fluid" ng-controller = "paymnetParentController" >
				<!-- Content -->
				<div class="content-area py-1">
					<div class="container-fluid">
						<div class="col-md-12 col-sm-12 table-mobile">
							<table class="table table-hover payment-table table-tab1">
								<thead>
									<tr>
                                ...
                                @foreach($data as $da)
									<tr>
										<td>{{$da['reffernce_no']}}</td>
										<td><a href="{{route('details_order')}}/{{$da['reffernce_no']}}/{{$da['order_id']}}" target="_blank">{{$da['order_id']}}</a></td>
									</tr>
								@endforeach
								</tbody>
							</table>
