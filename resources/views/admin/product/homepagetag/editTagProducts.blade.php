		...
		<div class="box box-block bg-white">	
			...
			<h3>{{ $item->tag}} </h3>	
				...
				@endif
					...
					<li class="demo-tabs"><a href="{{url('admin/product/homepagetag/'.$item->tagid)}}" class="btn btn-black w-min-sm mb-0-25 waves-effect waves-light">Back</a></li>
					
				</ul>
			</div>
		</div>
		{{Form::open(['class'=>'form-horizontal company', 'files' =>'true','method'=>'post', 'action'=>['Admin\Product\HomepageTagController@updateTagProducts', $item->id]])}}
