...
@section('content')
		...
		<ol class="breadcrumb no-bg mb-1">
			...
			<li class="breadcrumb-item active">Add Homepage Hot Deal</li>
		</ol>
		<div class="box box-block bg-white">	
		
			<div class="row cc-row header-row">	
			<h3>Add Homepage Hot Deal</h3>			
		...
		{{Form::open(['class'=>'form-horizontal company', 'files' =>'true','method'=>'post', 'action'=>['Admin\Product\HomepageTagController@producthotdealstore']])}}
		 
		<div class="col-lg-6 col-md-10">			
				<div class="form-group row">
					<label for="example-text-input" class="col-xs-4 col-form-label">Deal Date Range</label>
					<div class="col-xs-8">
						<input class="form-control" name="daterange" value="{{Old('daterange')}}" type="text" readonly="true">
