...
<link rel="stylesheet" type="text/css" href="{{asset(ADMIN_FILE_PATH.'/css/owl.carousel.css')}}">
<link rel="stylesheet" type="text/css" href="{{asset(ADMIN_FILE_PATH.'/css/owl.theme.css')}}">
<link rel="stylesheet" type="text/css" href="{{asset(ADMIN_FILE_PATH.'/css/jquery.bxslider.css')}}">
<link rel="stylesheet" type="text/css" href="{{asset(ADMIN_FILE_PATH.'/css/jquery.mobile-menu.css')}}">
<link rel="stylesheet" type="text/css" href="{{asset(ADMIN_FILE_PATH.'/css/revslider.css')}}">
...
<script type="text/javascript" src="{{asset(ADMIN_FILE_PATH.'/js/revslider.js')}}"></script> 
<script type="text/javascript" src="{{asset(ADMIN_FILE_PATH.'/js/common.js')}}"></script> 
<script type="text/javascript" src="{{asset(ADMIN_FILE_PATH.'/js/owl.carousel.min.js')}}"></script> 
<script type="text/javascript" src="{{asset(ADMIN_FILE_PATH.'/js/jquery.mobile-menu.min.js')}}"></script> 
<script type="text/javascript" src="{{asset(ADMIN_FILE_PATH.'/js/countdown.js')}}"></script> 
...
@if(Session::has('error') || $errors->has('data'))
	<script type="text/javascript"> 
...
<div id="page"> 
	...
	<header>
				...
				<div class="container">
					<div class="row"> 
						...
						<div class="col-xs-12 col-sm-6">
							<!-- <div class="dropdown block-language-wrapper"> <a role="button" data-toggle="dropdown" data-target="#" class="block-language dropdown-toggle" href="#"> <img src="{{url('images/english.png')}}" alt="language"> English <span class="caret"></span> </a>
								<ul class="dropdown-menu" role="menu">
									<li role="presentation"> <a href="#"><img src="{{url('images/english.png')}}" alt="language"> English </a> </li>
									<li role="presentation"> <a href="#"><img src="{{url('images/francais.png')}}" alt="language"> French </a> </li>
									<li role="presentation"> <a href="#"><img src="{{url('images/german.png')}}" alt="language"> German </a> </li>
								</ul>
							</div> -->
							<!-- End Header Language --> 
					...
					<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 logo-block"> 
						...
						<div class="logo logodiv">
							<div class="logobox">
								<div class="col-md-6">
									<center>
										<img src="{!! url('product_images/banners/',[$logo->image]) !!}" class="img-responsive">
									</center>
								</div>
								<div class="col-md-6 logotext">
									<center>
										<a href="{{url('admin/website-setting/add?cid=1')}}" class="btn mybtn w-min-xs mb-0-25 waves-effect waves-light">Edit</a>
									</center>
								</div>
							</div>
								...
								<div class="subscribe-link">
									<ul class="social-link">
						                ...
						                @foreach($socialmedia as $social)
						                  <li><a href="{{url('admin/socialmedia/editsocial/'.$social->id)}}" title="{{ $social->name}} "><i class="fa fa-{{$social->slug}}"></i></a></li>
						                @endforeach
						                @endif
									</ul>
									<p class="discount-text">
									{!! $homesetting->socialright !!}										
										<div class="discounted">
											<center><a href="#" data-toggle="modal" data-target="#st_phone" data-whatever="{{ $homesetting->socialright }}" data-datakey="socialright" class="btn mybtn w-min-xs mb-0-25 waves-effect waves-light">Edit</a></center>
										</div>
									</p>
								</div>
							</div>
        ...
        <div class="top-products">
        	...
        	<div class="title">{{$topproduct[0]['tagname']}} - <a href="#" style="display:inline;"><span class="editpop">Edit</span></a></div>
        	@if(isset($topproduct) && count($topproduct[0]['products'])>0)
        	<ul>
        		...
        		<li>
        			<div class="row vrow">
        				<div class="orow">
        					<div class="col-md-6">
        						<center>
        							<img src="{{url('images/img-sm.png')}}">
        						</center>
        					</div>
        					<div class="col-md-6 text2">
        						<center>
        							<a href="{{url('admin/product/editTagProducts/'.$tag_product->id)}}" class="btn mybtn w-min-xs mb-0-25 waves-effect waves-light">Edit</a>
        						</center>
        					</div>
        				</div>
        				<div class="col-xs-4 col-sm-4 no-margin"> <img alt="product" src="{!! url('products-images/',[$tag_product->image]) !!}"> </div>
        				<div class="col-xs-8 col-sm-8 no-margin"> <a href="#"> {!! $tag_product->name !!}</a>
        					<div class="rating">
        						<div class="ratings">
        					...
        					<div class="price"><i class="fa fa-inr"></i>{!! $tag_product->new_price !!}</div>
        				</div>
    ...
    <div class="col-md-6 col-sm-7 col-xs-12">
    	<div class="small-strip">
    		...
    		<div class="title">{{ $homesetting->topbanner }} - <a href="#" data-toggle="modal" data-target="#st_phone" data-whatever="{{ $homesetting->topbanner }}" data-datakey="topbanner"><span class="editpop">Edit</span></a></div>
    		<div class="title-text">Shop Now</div>
    	</div>
    	<div id='rev_slider_4_wrapper' class='rev_slider_wrapper fullwidthbanner-container slidediv'>
    		<div class="slidebox">
    			<center>
    				<img src="{{url('images/img.png')}}">
    				<br/><br/>
    				<a href="{{url('admin/website-setting/sliders')}}" class="btn mybtn w-min-sm mb-0-25 waves-effect waves-light">Edit</a>
    				<div class="row">
    		...
    		<div id='rev_slider_4' class='rev_slider fullwidthabanner'>
    			...
    			<li data-transition='random' data-slotamount='7' data-masterspeed='1000' data-thumb="{!! url('product_images/banners/',[$slider->image]) !!}"><img src="{!! url('product_images/banners/',[$slider->image])!!}" alt="{{$slider->image}} slide" data-bgposition='left top' data-bgfit='cover' data-bgrepeat='no-repeat' />
					<?php /* ?><div class="info">
    ...
    <div class=" col-lg-3 col-md-3 col-sm-7 col-xs-12">
    	<div class="image-item o-item">
    		<a href="#" title="Image">
    			<img src="{!! url('product_images/banners/',[$right1->image]) !!}" class="img-responsive" alt="Image" width="244px">
    		</a>
    		<div class="obox <?php echo is_file(public_path('product_images/banners/'.$right1->image)) ? '' : 'obox_nomargin' ?>">
    			<center>
    				<img src="{{url('images/img.png')}}">
    				<br/><br/>
    				<a href="{{url('admin/website-setting/add?cid=3')}}" class="btn mybtn w-min-sm mb-0-25 waves-effect waves-light">Edit</a>
    				<div class="row">
					...
					<div class="slider-items-products">
						<div class="bestsell-block">
							<div class="block-title">
								<h2>{{ $product['tagname'] }} - <a href="{{url('admin/product/homepagetag/'.$product['id'].'/edit')}}"><span class="editpop">Edit</span></a></h2>
							</div>
									...
									<div class="item oinfo">
										<div class="infobox">
											<center>
												<img src="{!! url('images/img.png') !!}">
												<br/><br/>
												<a href="{{url('admin/product/editTagProducts/'.$tag_product->id)}}" class="btn mybtn w-min-sm mb-0-25 waves-effect waves-light">Edit</a>
											</center>
											<div class="row">
										...
										<div class="item-inner">
											<div class="item-img">
												<div class="item-img-info"> <a class="product-image" title="{{$tag_product->name}}" href="#"> <img alt="{{$tag_product->name}}" src="{!!url('products-images/',[$tag_product->image])!!}"> </a>
												</div>
											</div>
											<div class="item-info">
												<div class="info-inner">
													<div class="item-title"> <a title="{{ $tag_product->name }}" href="#product_detail.html"> {{ $tag_product->name }} </a> </div>
													<div class="item-content">
														...
														<div class="item-price">
															<div class="price-box"> <span class="regular-price"> <span class="price">{{$tag_product->new_price}}</span> </span> </div>
														</div>
														<div class="action">
			...
			<div class="col-md-3">
				<div class="hot-deal">
					...
					<ul class="products-grid">
						<div class="opbox <?php echo $hotdeals && is_file(public_path('products-images/'.$hotdeals[0]['image'])) ? "" : "obox_nomargin"?>">
							<center>
								<img src="{{url('images/img.png')}}"><br/><br/>
								<a href="{{($hotdeals) ? url('admin/product/producthotdealedit/'.$hotdeals[0]['id']) : url('admin/product/product-hot-deal')}}" class="btn mybtn w-min-sm mb-0-25 waves-effect waves-light">Edit</a>
								<div class="row">
						...
						<li class="right-space two-height item">
							<div class="item-inner">
								...
								<div class="item-info">
									<div class="info-inner">
										<div class="item-title"> <a href="#product_detail.html" title="Retis lapen casen"> {!! $result['name'] !!} </a> </div>
										<div class="item-content">
											<div class="rating">
												<div class="ratings">
													<div class="rating-box">
											...
											<div class="item-price">
												<div class="price-box"> <span class="regular-price"> <span class="price">{!! $result['new_price'] !!}</span> </span> </div>
											</div>
											<div class="action">
							...
							<div class="slider-items slider-width-col1 owl-carousel owl-theme"> 
								...
								<div class="item">
									<div class="inner-block testitem">
										<div class="tesitem">
											<img src="{{url('images/img.png')}}"><br/><br/>
											<a href="{{url('admin/testimonials/'.$testimonial->id.'/edit')}}" class="btn mybtn w-min-sm mb-0-25 waves-effect waves-light">Edit</a>
										</div>
				...
				<div class="home-side-banner">
					<div class="sideban <?php echo is_file(public_path('product_images/banners/'.$right2->image)) ? "" : "obox_nomargin"?>">
						<center>
							<img src="{{url('images/img.png')}}"><br/><br/>
							<a href="{{url('admin/website-setting/add?cid=4')}}" class="btn mybtn w-min-sm mb-0-25 waves-effect waves-light">Edit</a>
							<div class="row">
								<p class="c-white">Preferred Dimensions<br/><span class="gehara">200 X 50</span></p>
								<p class="c-white">Preferred File Size: 600 KB</p>
							</div>
					...
					<img alt="banner" src="{!! url('product_images/banners/',[$right2->image]) !!}" class="full-width" alt="Image">
				</div>
				<div class="spacer" style="height:10px;"></div>
				<div class="side-banner-img">
					<div class="sideban2 <?php echo is_file(public_path('product_images/banners/'.$right3->image)) ? "" : "obox_nomargin"?>">
						<center>
							<img src="{{asset('images/img.png')}}"><br/><br/>
							<a href="{{url('admin/website-setting/add?cid=5')}}" class="btn mybtn w-min-sm mb-0-25 waves-effect waves-light">Edit</a>
							<div class="row">
								<p class="c-white">Preferred Dimensions<br/><span class="gehara">200 X 50</span></p>
								<p class="c-white">Preferred File Size: 600 KB</p>
							</div>
					...
					<a href="#" title="Image">
						<img src="{!! url('product_images/banners/',[$right3->image]) !!}" class="full-width" alt="Image">
					</a>
				</div>
			</div>
		</div>
	...
	<div class="footer-add-item">
		<div class="col-md-4">
			...
			<div class="col-md-4 edit-btn ">
				<center>
					<a href="{{url('admin/website-setting/add?cid=6')}}" class="btn mybtn w-min-sm mb-0-25 waves-effect waves-light">Edit</a>
				</center>
			</div>
		
	</div>
	<a href="{{url('admin/website-setting/add?cid=6')}}">
		<img src="{!!url('product_images/banners/',[$contentstrip->image])!!}" class="purnawidth">
	</a>
</div>
...
<footer class="myfooter">
	<!-- <div class="footer-add">
		...
		<a href="{{url('admin/website-setting/add?cid=6')}}">
			<img src="{!!url('product_images/banners/',[$contentstrip->image])!!}" alt="img-responsive">
		</a>
	</div> -->
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-4">
					<h4>Support</h4>
					<ul> 
						<li style="margin:10px 0;"><a style="font-size:20px;margin:10px 0;" id="alt_phone" href="#" data-toggle="modal" data-target="#st_phone" data-whatever="{{ $homesetting->phone }}" data-datakey="phone"><i class="fa fa-phone"></i> +91-{{ $homesetting->phone }} - <span class="editpop">Edit</span></a></li>
						<li style="padding-bottom:10px;border-bottom:1px solid #f2d03b;"><a href="#" data-toggle="modal" data-target="#st_phone" data-whatever="{{ $homesetting->email }}" data-datakey="email"><i class="fa fa-envelope-o"></i> {{ $homesetting->email }} - <span class="editpop">Edit</span></a></li>
						<li style="margin:10px 0 0 0;"><a href="{{url('admin/socialmedia')}}"><h4>SOCIALIZE WITH US - <span class="editpop">Edit</span></h4></a>
				...
				<div class="col-sm-4">
					<a href="{{url('admin/pages')}}"><h4>Quick Links</h4></a>
					<ul class="links">
					@foreach($pages as $page)
						<li class="first"><a href="{{ url('admin/pages/'.$page->id.'/edit') }}" title="{{ $page->alias }}">{{ $page->name }} - <span class="editpop">Edit</span></a></li>
					@endforeach	
...
<div class="modal fade" id="st_phone" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			{!! Form::open(['method'=>'post', 'action' => ['Admin\WebsiteSetting\HomepageSettingController@homesetting']])  !!}
			...
			<input type="hidden" class="form-control" name="key">										
				<div class="form-group row">
					...
					<div class="col-xs-9">
						...
						@if($errors->has('data')) <span class="text-danger">{{ $errors->first('data') }} </span> @endif
					</div>
				</div>																			
			</div>
