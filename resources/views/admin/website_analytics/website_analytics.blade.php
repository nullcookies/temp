...
@section('pageScripts')
	...
	<script type="text/javascript" src="{{asset(ADMIN_FILE_PATH.'/vendor/chartjs/Chart.bundle.min.js')}}"></script>
										...
										<div class="col-md-4">
											<div class="col-xs-12 active-box">
												<div class="box-block tile tile-2 bg-success mb-2 user-data">
													...
													<div class="t-content">
														<h6>Users</h6>
														<h1 class="mb-1">{{$recently_active}}</h1>
											...
											<div class="col-xs-12">
												<div class="box-block tile tile-2 bg-primary mb-2">
													...
													<div class="t-content">
														<h1 class="mb-1">{{$today_sessions}}</h1>
