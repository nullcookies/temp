          ...
          <div class="col-1 new-users"><strong>New Customers</strong>
            <div class="content">
              ...
              <div class="buttons-set">
                <a href="{!! url('login') !!}" class="button create-account" type="button"><span>Login</span></a>
              </div>
            </div>
          </div>
            ...
            <div class="content">
              ...
              <ul class="form-list">
                <li>
                  ...
                  <br>
                  <input type="text" title="Name" class="input-text required-entry" id="name" name="name" value="{{ old('name') }}">
                </li>
        <li>
                  <label for="mobile">Mobile <span class="required">*</span></label>
                  <br>
                  <input type="text" title="Email Address" class="input-text required-entry" id="mobile" name="mobile" value="{{ old('mobile') }}">
                </li>
        <li>
                  <label for="email">Email Address <span class="required">*</span></label>
                  <br>
                  <input type="text" title="Email Address" class="input-text required-entry" id="email" name="email" value="{{ old('email') }}">
                </li>
                <li>
