										...
										<tbody>
											<tr>
												<td style="padding:40px 0;" align="center">
													<img src="{{asset('massengers/emailer_images/logo.png')}}" align="center" border="0" vspace="0" hspace="0" alt="">
												</td>
											</tr>
										</tbody>
									</table>
							...
							<tr>
								<td align="center" valign="top" style="padding-top:0px;padding-left:20px;padding-right:20px">
									<table width="600" border="0" cellpadding="0" cellspacing="0" align="center" bgcolor="#FFFFFF">
										<tbody>
											<tr>
												<td><img src="{{asset('massengers/emailer_images/spacer2.png')}}" align="center" border="0" vspace="0" hspace="0" alt=""></td>
										...
										<tbody>
											<tr>
												<td align="center" style="color:#4e4e4e;padding-top:0px;padding-bottom:0px;padding-left:40px;padding-right:40px;font-size:16px;">
													<h4 style="font-weight:400;font-family: 'Roboto', sans-serif;font-size:30px;color:#d80003;margin:0;margin-top:20px;">Hi {!! $order->customerName !!}</span></h4> 
										...
										<tbody>
											<tr>
												<td align="left" style="color:#4e4e4e;padding-top:0px;border:2px solid #4e4e4e;border-left:none;border-right:none;padding-bottom:20px;padding-left:40px;padding-right:40px;font-size:16px;">
													<h4 style="font-weight:900;font-family: 'Roboto', sans-serif;font-size:16px;color:#fff;margin:0;margin-top:20px;"><span style="background-color:#d80003;padding:0 5px;">Order ID</span> : <span style="color:#d80003;padding:0 5px;">{!! $order->id !!}</span></h4> 												
												</td>
												<td align="left" style="color:#4e4e4e;padding-top:0px;border:2px solid #4e4e4e;border-left:none;border-right:none;padding-bottom:20px;padding-left:40px;padding-right:40px;font-size:16px;">
													<h4 style="font-weight:900;font-family: 'Roboto', sans-serif;font-size:16px;color:#4e4e4e;margin:0;margin-top:20px;">Placed on : {!! Carbon\Carbon::parse($order->created_at)->format('D d-m-Y') !!}</span></h4> 												
												</td>
											</tr>
										</tbody>
									</table>
								...
								<td align="center" valign="top" style="padding-left:20px;padding-right:20px;">
									<table width="600" border="0" cellpadding="0" cellspacing="0" align="center" bgcolor="#FFFFFF">
										<tbody>
											...
											<tr>
												<td align="left" style="color:#4e4e4e;padding-top:0px;padding-bottom:20px;padding-left:40px;padding-right:40px;font-size:16px;">
													<h4 style="font-weight:400;font-family: 'Roboto', sans-serif;font-size:16px;color:#4e4e4e;margin:0;">{!! $order->shippingName !!}</h4>
													<h4 style="font-weight:400;font-family: 'Roboto', sans-serif;font-size:16px;color:#4e4e4e;margin:0;">{!! $order->shippingAddress !!}</h4>
													<h4 style="font-weight:400;font-family: 'Roboto', sans-serif;font-size:16px;color:#4e4e4e;margin:0;">{!! $order->shippingCity !!} - {!! $order->shippingPostCode !!}</h4>
													<h4 style="font-weight:400;font-family: 'Roboto', sans-serif;font-size:16px;color:#4e4e4e;margin:0;">{!! $order->shippingState !!}, India</h4>	
												</td>
												<td align="left" style="color:#4e4e4e;padding-top:0px;vertical-align:top;padding-bottom:20px;padding-left:40px;padding-right:40px;font-size:16px;">
													<h4 style="font-weight:400;font-family: 'Roboto', sans-serif;font-size:16px;color:#4e4e4e;margin:0;">+91-{{$order->shippingPhone}}</h4> 												
												</td>
											</tr>
										</tbody>
									</table>
										...
										<tbody>
											...
											<tr>
												...
												<td align="right" style="color:#4e4e4e;padding-top:10px;vertical-align:top;padding-bottom:10px;padding-left:40px;padding-right:40px;font-size:16px;border-bottom: 1px solid #ccc;">
													<h4 style="font-weight:900;font-family: 'Roboto', sans-serif;font-size:16px;color:#4e4e4e;margin:0;">Rs. {!! $order->orderAmount !!}</h4> 												
												</td>
											</tr>
										</tbody>
									</table>
								...
								<td align="center" valign="top" style="padding-left:20px;padding-right:20px;padding-top:20px;padding-bottom:20px;">
									<table width="600" border="0" cellspacing="0" cellpadding="0" bgcolor="#fff" align="center">
										<tbody style="text-align:center">	
											<tr>
												<td>
												<a href="https://www.facebook.com/techturtle12/" style="padding:10px;"><img src="{{asset('massengers/emailer_images/fb.png')}}"></a>
												<a href="https://twitter.com/techturtlein" style="padding:10px;"><img src="{{asset('massengers/emailer_images/tw.png')}}"></a>
												<a href="https://plus.google.com/u/1/108896876946228247659" style="padding:10px;"><img src="{{asset('massengers/emailer_images/g+.png')}}"></a>
												<a href="https://www.linkedin.com/company/techturtle" style="padding:10px;"><img src="{{asset('massengers/emailer_images/link.png')}}"></a></td>	
											</tr>
											<tr>
												<td>
