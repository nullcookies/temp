{!! Form::open(array('id' => 'save_billing_address_form')) !!}
          ...
          <li>
            <div class="customer-name">
              <div class="input-box name-firstname">
                ...
                <br>
                <input type="text" id="billing_first_name" name="billing_first_name" value="{{$buynow->billing_first_name}}" title="First Name" class="input-text required-entry">
              </div>
              <div class="input-box name-lastname">
                <label for="billing:lastname"> Last Name <span class="required">*</span> </label>
                <br>
                <input type="text" id="billing_last_name" name="billing_last_name" value="{{$buynow->billing_last_name}}" title="Last Name" class="input-text required-entry">
              </div>
            </div>
          </li>
          <li>
            <div class="input-box name-firstname">
              ...
              <br>
              <input type="text" id="billing_email"  name="billing_email" value="{{$buynow->billing_email}}" title="Email" class="input-text">
            </div>
            <div class="input-box name-lastname">
              <label for="billing:mobile">Mobile <span class="required">*</span> </label>
              <br>
              <input type="text" id="billing_mobile" name="billing_mobile" value="{{$buynow->billing_mobile}}" title="Mobile" class="input-text">
            </div>
          </li>
<li>
<div class="input-box">
              ...
              <br>
              <input type="text" title="Zip/Postal Code" name="billing_pincode" id="billing_pincode" value="{{$buynow->billing_pincode}}" class="input-text validate-zip-international required-entry">
            </div>
<div id="" class="input-box">
              <label for="billing:region">State/Province <span class="required">*</span></label>
              <br>
              <input type="text" name="billing_state" id="billing_state" value="{{$buynow->billing_state}}" title="State/Province" class="input-text required-entry">
...
<div class="input-box">
              ...
              <br>
              <input type="text" title="City" name="billing_city" value="{{$buynow->billing_city}}" class="input-text required-entry" id="billing_city">
            </div>
<div class="input-box">
              <label for="billing:country_id">Country <span class="required">*</span></label>
              <br>
              <input type="text" title="Country" name="billing_country" value="{{$buynow->billing_country}}" class="input-text required-entry" id="billing_country">
            </div>
</li>
          <li>
            <label for="billing:street1">Address <span class="required">*</span></label>
            <br>
            <textarea name="billing_street_address"  id="billing_street_address" title="Address" resizable="none" class="required-entry input-text textarea-resize" cols="5" rows="3">{{$buynow->billing_street_address}}</textarea>
          </li>
        </ul>
      </fieldset>
    </li>
