          ...
          <div class="col-main">
            <div class="product-view">
              <div class="product-essential">
                {!! Form::open(array('id' => 'product_detail_form', 'method' => 'post', 'action' => ['Front\Cart\CartController@addToCartAjax'])) !!}
                  ...
                  <div class="product-img-box col-lg-4 col-sm-4 col-xs-12" style="text-align: center;">
                    ...
                    <div class="product-image">
                      <div class="product-full"> <img id="product-zoom" src="{{$defaultImage}}" data-zoom-image="{{$defaultImage}}" alt="product-image"/> </div>
                      <div class="more-views">
                        <div class="slider-items-products">
                          <div id="gallery_01" class="product-flexslider hidden-buttons product-img-thumb">
                            <div class="slider-items slider-width-col4 block-content">
                            @foreach($productImages as $productImage)
                              <div class="more-views-items"> <a href="javascript:;" data-image="{{$image[$productImage->id]}}" data-zoom-image="{{$image[$productImage->id]}}"> <img id="product-zoom"  src="{{$imageSmall[$productImage->id]}}" alt="product-image"/> </a></div>
                            @endforeach
                            </div>
                          </div>
                        </div>
                    ...
                    <div class="easyzoom easyzoom--overlay easyzoom--with-thumbnails">
                      <div class="mainbox" style="/* max-width: 100%; *//* border:1px solid #000; */position: relative;text-align: center;overflow: hidden;">
                        <div class="newbox" style="/* width: 100%; *//* overflow: hidden; *//* position: relative; *//* height: 450px; */text-align: center;-webkit-transition: all 0.3s ease-out;-moz-transition: all 0.3s ease-out;-o-transition: all 0.3s ease-out;transition: all 0.3s ease-out;position: relative;">
                          <a href="{{$defaultImage}}" style="/* width: auto; *//* position: relative; *//* height: inherit; */width: 100%;overflow: hidden;display: inline-block;">
                            <img src="{{$defaultImage}}" alt="" width="100%" style="/* height:inherit; */height: auto;max-height: 450px;width: auto !important;max-width: 400px;min-height: 450px !important;" />
                          </a>
                        </div>  
                      </div>  
                    </div>
                    ...
                    <div class="item thumbnails">
                      ...
                      <li>
                        <a href="{{$image[$productImage->id]}}" data-standard="{{$image[$productImage->id]}}">
                          <img src="{{$imageSmall[$productImage->id]}}" alt="" />
                        </a>
                      </li>
                  ...
                  <div class="product-shop col-lg-5 col-sm-5 col-xs-12">
                    ...
                    <div class="price-block">
                      <div class="price-box">
                        <p class="special-price"> <span class="price-label">Special Price</span> <span id="product-price-48" class="price"> <i class="fa fa-inr"></i> {{$product->product_selling_price}} </span> </p>
                        ...
                        <p class="availability in-stock pull-right"><span>{{$stockStatus}}</span></p>
                      </div>
                    </div>
                    ...
                    <div class="col-sm-12 mt-1">
                      <div class="col-xs-4 lh-fix">
                        {{$varientType->varient_type}}
                      </div>
                      <div class="col-xs-8"> 
                        @if(count($varientValues[$varientType->varient_type_id]) > 1)
                        <select name="{{$varientType->varient_type}}">
                          @foreach($varientValues[$varientType->varient_type_id] as $varient_value)
                            <option value="{{$varient_value->id}}">{{$varient_value->value}}</option>
                          @endforeach
                        </select>
                        @else
                          @foreach($varientValues[$varientType->varient_type_id] as $varient_value)
                            <input type="hidden" name="{{$varientType->varient_type}}" value="{{$varient_value->id}}" >     
                            <strong>{{$varient_value->value}}</strong>                     
                          @endforeach
                        @endif
                      </div>
                    </div>
                    ...
                    <div class="add-to-box">
                      ...
                      <!--<div class="email-addto-box">
                        <ul class="add-to-links">
                          <li> <a class="link-wishlist" href="javascript:;" onclick="addtowishlist({{$product->id}})"><span>Add to Wishlist</span></a></li>
          ...
          <div id="related-products-slider" class="product-flexslider hidden-buttons">
            <div class="home-block-inner">
              <div class="block-title">
               ...
               <img alt="banner" src="{{asset('images/banner-img.png')}}">
            </div>
                  ...
                  <div class="item-inner">
                    <div class="item-img">
                      <div class="item-img-info">
                        <a class="product-image" title="Retis lapen casen" href="product_detail.html"> <img alt="ThinkPad X1 Ultrabook" src="{{asset('images/product-img.jpg')}}"> </a>
