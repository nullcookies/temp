...
<!--<link rel="stylesheet" href="<?php echo e(asset(ADMIN_FILE_PATH.'/vendor/font-awesome/css/font-awesome.min.css')); ?>">-->
...
<link rel="stylesheet" href="<?php echo e(asset(ADMIN_FILE_PATH.'/vendor/morris/morris.css')); ?>">
<link rel="stylesheet" href="<?php echo e(asset(ADMIN_FILE_PATH.'/vendor/jvectormap/jquery-jvectormap-2.0.3.css')); ?>">