  ...
  $(function () {
    ...
    var $body = $('body');
      ...
      (function () {
        ...
        var options = {
          aspectRatio: <?php echo e($width); ?> / <?php echo e($height); ?>,
          preview: '.img-preview',
          strict:false,
          crop: function (e) {
...
<script>
  function saveCropImage(object){       
    ...
    var redir       = "<?php echo e($redir); ?>";
    var upc         = "<?php echo e($upc); ?>";
    $.ajax({
      url : "<?php echo e(url('/admin/product/imagescrop')); ?>",
      type: 'POST',
  ...
  <div class="row">
    <div class="col-md-9">
      ...
      <div class="img-container">
        <img src="<?php echo url($imgpath. '/',[$img]); ?>" alt="Picture">
      </div>
    </div>
    <div class="col-md-3">
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <?php echo Form::open(array('method' => 'get', 'action' => ['Admin\Product\ProductController@saveimagescrop'])); ?>
