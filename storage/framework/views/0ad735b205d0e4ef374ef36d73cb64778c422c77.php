	...
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="mess">
			<ul class="nav navbar-nav navbar-left hidden-xs">
				...
				<li>
					<a href="<?php echo e(url('/corporate')); ?>" title="Corporate" class="new-image">
						<img src="<?php echo e(asset('massengers/img/co.png')); ?>" alt="Corporate"/>
						<p>Corporate</p>
					</a>
				</li>
			</ul>
			<ul class="nav navbar-nav navbar-right hidden-xs">
				...
				<li class="login-hover">
					<a href="javascript:;" class="new-image" title="Profile">
						...
						<p class="user-name">Hi <?php echo e(substr(Auth::user()->name,0,15)); ?></p>
					</a>
					<ul class="hover">
	...
	<ul class="nav navbar-nav mob-menu hidden-sm hidden-md hidden-lg">
		...
		<li>
			<a href="<?php echo e(url('profile')); ?>" class="new-image">
				...
				<p class="mobile-user-name">Hi <?php echo e(substr(Auth::user()->name,0,15)); ?></p> 
			</a>
		</li>
		<?php endif; ?>
...
<div id="mySidenav" class="sidenav">
  <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>
	...
	<a href="<?php echo e(url('/corporate')); ?>">
		...
		<div class="row footer-details">
			...
			<div class="col-md-4 serivces-divs"> 
				<ul class="service-list">
					...
					<li><a href="<?php echo e(url('/category/cakes')); ?>" title="Delicious Cakes">Delicious Cakes</a></li>
