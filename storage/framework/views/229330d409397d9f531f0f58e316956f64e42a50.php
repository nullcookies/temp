	...
	<div class="main">
		<table style="border-bottom:2px solid;" class="main">
			<tbody>
				<tr>
					<center>
						<th style="text-align: center;font-family: 'Raleway', sans-serif;" class="main forcenter sizeheading "><?php echo e($website_name); ?><br/>
						<img src="<?php echo e(url('/barcode/'.$orders->awb_number)); ?>" width="100"><br/><?php echo e($orders->awb_number); ?>
		...
		<table cellspacing="0" cellpadding="2" class=" main" style="margin-top:10px; padding-bottom:10px;border-spacing: 0px;border-bottom:2px solid;">
        	<tbody>
                <tr>
	                ...
	                <p class="detail"><?php echo e(ucwords(strtolower($orders->shippingName))); ?></p>
	                <p class="detail"><?php echo $orders->shippingAddress; ?></p>
	                <p class="detail"><?php echo e($orders->shippingCity); ?>, <?php echo e($orders->shippingState); ?></p>
	                <p class="detail">Pin - <?php echo e($orders->shippingPostCode); ?></p>
	                <p class="detail">Mob. <?php echo e($orders->shippingPhone); ?></p>
	                </th>
					...
					<td colspan="1" style="text-align: center; border:2px solid; font-weight:bold;" class="forright  sizeheading"><?php echo e($orders->paymentType == 'cod' ? 'Cash On Delivery' : 'Prepaid'); ?><br/>
					<?php if($orders->paymentType == 'cod'): ?>
                        <p>Please Collect</p>
    					<p>Rs. <?php echo e($orders->orderAmount + $orders->shippingCharge); ?></p>
	                <?php endif; ?>
	                </td>
                </tr>
            </tbody>
        ...
        <table cellspacing="0" cellpadding="2" class=" main" style="margin-top:10px;border-spacing: 0px;font-size:10px;">
                ...
                <?php $sn = 1; ?>
                    <?php foreach($orders->products as $product): ?> 
                        <tr style="border-bottom:2px solid;">
        					<td style="padding:5px 0;"><?php echo ucwords(strtolower($product->product_name)); ?></td>
        					<td style="vertical-align:top;text-align:center;padding:5px;"><?php echo e($product->quantity); ?></td>
        					<td style="vertical-align:top;text-align:center;padding:5px 10px;">Rs.<?php echo e($product->selling_price); ?></td>
        					<td style="vertical-align:top;text-align:center;padding:5px 10px;">Rs.<?php echo e($product->selling_price * $product->quantity); ?></td>
        				</tr>
                    <?php endforeach; ?>
			...
			<tfoot>
				<tr>
					...
					<td style="vertical-align:top;text-align:right;padding:5px 10px;font-weight:bold;">Rs.<?php echo e($orders->orderAmount); ?></td>
				</tr>
				<tr>
					<td colspan="2"></td>
					...
					<td style="vertical-align:top;text-align:right;padding:5px 10px;font-weight:bold;border-bottom: 2px solid #000;">Rs.<?php echo e($orders->shippingCharge); ?></td>
				</tr>
				<tr>
					<td colspan="2"></td>
					<td style="vertical-align:top;text-align:center;padding:5px 10px;font-weight:bold;">Total Cost</td>
					<td style="vertical-align:top;text-align:right;padding:5px 10px;font-weight:bold;">Rs.<?php echo e($orders->orderAmount + $orders->shippingCharge); ?></td>
				</tr>
			</tfoot>
        </table>
        	...
        	<tbody>
                <tr>
                    <th colspan="4" class=" forcenter forbold sizeheading " style="text-align:left;">
						...
						<p class="detail">Digi Retail</p>
						<p class="detail">Second Floor, 641/B1 ,</p>
						<p class="detail">Loni Road, Ram Nagar, shahdara,</p>
						<p class="detail">delhi , NCR - 110032</p>
						<p class="detail">Phone : 9999068877</p>
	                </th>
					<!--<td colspan="1" style="text-align: center;" class="forright  sizeheading">-->
						<th colspan="1" style="text-align: center;margin-bottom:10px;font-size:12px;" class="forright  sizeheading">Order no.<br/>
							<img src="<?php echo e(url('/barcode/'.$orders->id)); ?>" width="100"><br/><p><?php echo e($orders->id); ?></p>
