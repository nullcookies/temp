...
<div class="container-fluid pd-20">
	<div class="container">
		<div class="col-md-4">
			<img src="<?php echo e(url('massengers/img/about-us.PNG')); ?>" class="img-responsive"/>
		</div>
	...
	<div class="container meet-team">
		...
		<div class="row pd-20">
			<div class="col-md-3 col-sm-3">
				<img src="<?php echo e(asset('massengers/img/team1.jpg')); ?>" class="img-responsive"/>
				<br/>
		...
		<div class="row pd-20">
			<div class="team-box">
				<div class="col-md-3 col-sm-6 teamboximage">
    				<img src="<?php echo e(asset('massengers/img/team1-1.jpg')); ?>" class="img-responsive center-block"/>
    				<h3>Kendall Jenner</h3>
    				<p>Kendall Nicole Jenner is an American fashion model and television personality</p>
    			</div>
    			<div class="col-md-3 col-sm-6 teamboximage">
    				<img src="<?php echo e(asset('massengers/img/team1-2.jpg')); ?>" class="img-responsive center-block"/>
    				<h3>Kendall Jenner</h3>
    				<p>Kendall Nicole Jenner is an American fashion model and television personality</p>
    			</div>
    			<div class="col-md-3 col-sm-6 teamboximage">
    				<img src="<?php echo e(asset('massengers/img/team1-3.jpg')); ?>" class="img-responsive center-block"/>
    				<h3>Kendall Jenner</h3>
    				<p>Kendall Nicole Jenner is an American fashion model and television personality</p>
    			</div>
    			<div class="col-md-3 col-sm-6 teamboximage">
    				<img src="<?php echo e(asset('massengers/img/team1-4.jpg')); ?>" class="img-responsive center-block"/>
    				<h3>Kendall Jenner</h3>
    				<p>Kendall Nicole Jenner is an American fashion model and television personality</p>
    			</div>
			</div>
