...
<script src="https://code.jquery.com/jquery-1.12.4.min.js"></script>
  ...
  <script>  
    $(function () {
      ...
      (function () {
        ...
        var options = {
              aspectRatio: <?php echo e($w); ?> / <?php echo e($h); ?>,
              preview: '.img-preview',
              strict:false,
              crop: function (e) {
  ...
  <script>
      function saveCropImage(object){
        ...
        var path = "<?php echo e($imgpath); ?>";
        var cid = "<?php echo e($cid); ?>";
        var link = "<?php echo e($link); ?>";
        var imagename = "<?php echo e($img); ?>";
        $.ajax({
          url : "<?php echo e(url('/admin/jcrop/save')); ?>",
          type: 'POST',
          data: {imgdata:imageBase64,imagename:imagename,path:path,cid:cid,link:link},
          dataType: 'json',
          beforeSend: function (){
      ...
      if(isset($producthotdeal)){ ?>
        ...
        var producthotdeal = "<?php echo e($producthotdeal); ?>";
        var rating = "<?php echo e($rating); ?>";
        var old_price = "<?php echo e($old_price); ?>";
        var new_price = "<?php echo e($new_price); ?>";
        ...
        var end_date = "<?php echo e($end_date); ?>";
         ...
         $.ajax({
          url : "<?php echo e(url('/admin/jcrop/save')); ?>",
          type: 'POST',
          data: {imgdata:imageBase64,name:name,imagename:imagename,path:path,id:id,link:link,rating:rating,old_price:old_price,new_price:new_price,start_date:start_date,end_date:end_date,productImage:producthotdeal},
          dataType: 'json',
          beforeSend: function (){
            $('.modal-body').html("<img src='<?php echo e(url('images/loader/loading.gif')); ?>' />");
            $('#download').removeAttr("href").css("cursor","pointer");
      ...
      if(isset($products)){ ?>
        ...
        var imagename = "<?php echo e($img); ?>";
        var name = "<?php echo e($name); ?>";
        var products = "<?php echo e($products); ?>";
        var rating = "<?php echo e($rating); ?>";
        var old_price = "<?php echo e($old_price); ?>";
        var new_price = "<?php echo e($new_price); ?>";
        var tagid     = "<?php echo e($tagid); ?>"
       
         $.ajax({
          url : "<?php echo e(url('/admin/jcrop/save')); ?>",
          type: 'POST',
          data: {imgdata:imageBase64,name:name,imagename:imagename,path:path,id:id,link:link,rating:rating,old_price:old_price,new_price:new_price,tagid:tagid,products:products},
          dataType: 'json',
          beforeSend: function (){
            $('.modal-body').html("<img src='<?php echo e(url('images/loader/loading.gif')); ?>' />");
            $('#download').removeAttr("href").css("cursor","pointer");
  ...
  <div class="row">
      <div class="col-md-9">
        ...
        <div class="img-container">
          <img src="<?php echo url($imgpath. '/img/',[$img]); ?>" alt="Picture">
        </div>
      </div>
      <div class="col-md-3">
    ...
    <!--<div class="row docs-actions">
      <div class="col-md-9 docs-buttons">
        ...
        <div class="btn-group btn-group-crop">
          ...
          <button type="button" class="btn btn-primary hidden" data-method="getCroppedCanvas" data-option="{ &quot;width&quot;: 160, &quot;height&quot;: 90 }">
            <span class="docs-tooltip" data-toggle="tooltip" title="$().cropper(&quot;getCroppedCanvas&quot;, { width: 160, height: 90 })">
              160&times;90
            </span>
          </button>
          <button type="button" class="btn btn-primary hidden" data-method="getCroppedCanvas" data-option="{ &quot;width&quot;: 320, &quot;height&quot;: 180 }">
        ...
        <div class="modal fade docs-cropped" id="getCroppedCanvasModal" aria-hidden="true" aria-labelledby="getCroppedCanvasTitle" role="dialog" tabindex="-1">
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <?php echo Form::open(array('method' => 'get', 'action' => ['Admin\WebsiteSetting\WebsiteSettingController@savejcrop'])); ?>
      ...
      <!--<div class="col-md-3 docs-toggles">
        ...
        <label class="btn btn-primary active" data-method="setAspectRatio" data-option="<?php echo ($w/$h); ?>" title="Set Aspect Ratio">
            <input type="radio" class="sr-only" id="aspestRatio0" name="aspestRatio" value="<?php echo ($w/$h); ?>">
            <span class="docs-tooltip" data-toggle="tooltip" title="$().cropper(&quot;setAspectRatio&quot;, <?php echo $w/$h; ?>)">
              4:3
            </span>
          </label>
        ...
        <a class="btn btn-default btn-block " href="<?php echo e(url('/cropper/docs')); ?>" data-toggle="tooltip" target="_blank" title="Cropper without jQuery">Go to CropperJS</a>
