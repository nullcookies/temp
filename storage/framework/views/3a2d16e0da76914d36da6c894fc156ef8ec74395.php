			...
			<tbody>
				<tr>
					<td>
						<div class="col-md-3">
							<!-- <h3>Gaurav Sharma</h3> -->
							<input type="text" name="sender_name" value="<?php echo e($buynow->billing_first_name); ?>" class="delivery-control" placeholder="sender's Name"/>
						</div>
						<div class="col-md-4">
							<!-- <h3>+91 9582212488</h3> -->
						...
						<div class="col-md-5">
							...
							<input type="text" name="sender_email" value="<?php echo e($buynow->billing_email); ?>" class="delivery-control" placeholder="Sender's Email"/>
						</div>
					</td>
				</tr>
			</tbody>
