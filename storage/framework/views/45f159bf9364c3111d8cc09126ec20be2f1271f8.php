...
<link rel="stylesheet" href="<?php echo e(asset('css/jquery.mobile-1.4.5.min.css')); ?>">
<link rel="stylesheet" href="<?php echo e(asset('css/font-awesome.min.css')); ?>">
<link rel="stylesheet" href="<?php echo e(asset('css/styleMobile.css')); ?>">
<script src="<?php echo e(asset('js/jquery.mobile-1.4.5.min.js')); ?>"></script>
</head>
<body>
...
<div data-role="page" id="pageone">
 <div data-role="header">
    <div class="topheader">
		<ul class="headerlist">
      <?php if(Auth::user()): ?>
			<li><a target="_blank" href="<?php echo e(url('user/orders')); ?>"><i class="fa fa-user"></i> My Orders</a></li>
			<li><a target="_blank" href="<?php echo e(url('/cart')); ?>"><i class="fa fa-shopping-cart"></i> My Cart</a></li>
      ...
      <?php endif; ?>
		...
		<div class="cartdiv">
			<h3><a target="_blank" href="<?php echo e(url('/cart')); ?>" style="color: white;"><i class="fa fa-shopping-cart"></i></a> <span class="cartno"><?php echo e($cartCount); ?></span></h3>
		</div>
  	</div>
</div>
  <div data-role="main" class="ui-content">
    ...
    <h2>Categories</h2>
    <?php foreach($navCategories as $categoryLevel1): ?>
      <div data-role="collapsible" id="my-collapsible">
        <h3 class="mthin"><?php echo e($categoryLevel1['name']); ?></h3>
        <ul data-role="listview">
          <?php foreach($categoryLevel1['childs'] as $categoryLevel2): ?>
  	      <li><a target="_blank" href="<?php echo e(url('products?catid='.$categoryLevel2['category_id'])); ?>"><?php echo e($categoryLevel2['name']); ?></a>
          </li>
          <?php endforeach; ?>
	      </ul>
      </div>
  ...
  <a href="#">
    ...
    <ul data-role="listview" style="padding:15px; ">
      <?php if(Auth::user()): ?>
      <li><a target="_blank" href="<?php echo e(url('/url')); ?>">Cart</a></li>
      <li><a target="_blank" href="<?php echo e(url('/logout')); ?>">Logout</a></li>
      <?php else: ?>
