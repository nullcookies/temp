...
<script type="text/javascript">
	function fetchmodal(object){
		...
		$.ajax({
			url : "<?php echo e(url('admin/homepage/getAddCategoryModelContent')); ?>",
			type: 'get',
			dataType: 'html',
	...
	function editCategory(object){
		...
		var modalObj = $('#exampleModal');
		$.ajax({
			url: "<?php echo e(url('admin/homepage/getEditCategoryModelContent')); ?>",
			type: 'get',
			dataType : 'html',
	...
	function deleteCategory(object){
		...
		$.ajax({
			url : "<?php echo e(url('admin/homepage/getDeleteCategoryModelContent')); ?>",
			type: 'get',
			dataType: 'html',
...
<?php if(Session::has('save_success')): ?>
	<script>
	  $(document).ready(function(){
	    swal("<?php echo e(Session::get('save_success')); ?>", "", "success");
	  });
	</script>
<?php endif; ?>
      ...
      <div class="container">
        ...
        <div class="nav-inner"> 
          ...
          <?php foreach($categories as $categoryLevel1): ?>
            <li class="mega-menu"> 
        	<a class="level-top" id="accountIcon" data-navId="<?php echo e($categoryLevel1['id']); ?>" href="javascript:;">
        	<span><?php echo e($categoryLevel1['name']); ?></span>
        	<div class="editdiv-main">
				<ul>
				<li><a href="javascript:;" title="Edit" onclick="editCategory(this)" data-cname="<?php echo e($categoryLevel1['name']); ?>" data-catId="<?php echo e($categoryLevel1['category_id']); ?>" data-navId="<?php echo e($categoryLevel1['id']); ?>" data-toggle="modal" data-target="#exampleModal"><i class="fa fa-pencil"></i></a></li>
				<li><a href="javascript:;" title="Delete" onclick="deleteCategory(this)" data-cname="<?php echo e($categoryLevel1['name']); ?>" data-navId="<?php echo e($categoryLevel1['id']); ?>" data-catId="<?php echo e($categoryLevel1['category_id']); ?>" data-toggle="modal" data-target="#exampleModal"><i class="fa fa-times"></i></a></li>
				</ul>
			</div>
        	</a>
                  ...
                  <div class="level0-wrapper2">
                    <div class="nav-block nav-block-center"> 
                      ...
                      <?php foreach($categoryLevel1['childs'] as $categoryLevel2): ?>
                        <li class="level3 nav-6-1 parent item"> <a href="javascript:;" data-navId="<?php echo e($categoryLevel2['id']); ?>"><span><?php echo e($categoryLevel2['name']); ?></span></a> 
						<div class="editdiv">
							<ul>
							<li><a href="javascript:;" title="Edit" onclick="editCategory(this)" data-cname="<?php echo e($categoryLevel2['name']); ?>" data-catId="<?php echo e($categoryLevel2['category_id']); ?>" data-navId="<?php echo e($categoryLevel2['id']); ?>" data-toggle="modal" data-target="#exampleModal"><i class="fa fa-pencil"></i></a></li>
							<li><a href="javascript:;" title="Delete" onclick="deleteCategory(this)" data-cname="<?php echo e($categoryLevel2['name']); ?>" data-navId="<?php echo e($categoryLevel2['id']); ?>" data-catId="<?php echo e($categoryLevel2['category_id']); ?>" data-toggle="modal" data-target="#exampleModal"><i class="fa fa-times"></i></a></li>
							</ul>
						</div>
                          <ul class="level1">
                            ...
                            <li class="level2 nav-6-1-1"> 
								<div class="editdiv2">
									<ul class="buttonlist">
									<li><a href="javascript:;" title="Edit" onclick="editCategory(this)" data-cname="<?php echo e($categoryLevel3['name']); ?>" data-catId="<?php echo e($categoryLevel3['category_id']); ?>" data-navId="<?php echo e($categoryLevel3['id']); ?>" data-toggle="modal" data-target="#exampleModal"><i class="fa fa-pencil"></i></a></li>
									<li><a href="javascript:;" title="Delete" onclick="deleteCategory(this)" data-cname="<?php echo e($categoryLevel3['name']); ?>" data-catId="<?php echo e($categoryLevel3['category_id']); ?>" data-navId="<?php echo e($categoryLevel3['id']); ?>" data-toggle="modal" data-target="#exampleModal"><i class="fa fa-times"></i></a></li>
									</ul>
								</div>
							<a href="javascript:;" data-navId="<?php echo e($categoryLevel3['id']); ?>"><span><?php echo e($categoryLevel3['name']); ?></span></a>
							</li>
							<?php endforeach; ?>
							<li class="level2 nav-6-1-1"> 
								<a data-parent="<?php echo e($categoryLevel2['id']); ?>" data-catParent="<?php echo e($categoryLevel2['category_id']); ?>" onclick="fetchmodal(this)" href="javascript:;" class="c-blue" data-toggle="modal" data-target="#exampleModal"><span><i class="fa fa-plus-square-o"></i> Add Sub Category</span></a>
							</li>
                          </ul>
                        </li>
                       <?php endforeach; ?>
						...
						<li class="level3 nav-6-1 parent item pd-20">
							<center>
								<a onclick="fetchmodal(this)" data-parent="<?php echo e($categoryLevel1['id']); ?>" data-catParent="<?php echo e($categoryLevel1['category_id']); ?>" href="javascript:;" data-toggle="modal" data-target="#exampleModal">
