<html>
<head>
<title><?php echo $__env->yieldContent('title'); ?> Massengers</title>
...
<link rel="stylesheet" href="<?php echo e(asset('massengers/css/slimmenu.min.css')); ?>"/>
...
<nav class="navbar navbar-default" role="navigation">
	<div class="container">
		...
		<a class="navbar-brand hidden-xs" href="<?php echo e(url('/')); ?>" title="Massengers">
			<img src="<?php echo e(asset('massengers/img/logo.png')); ?>" alt="Massengers"  class="logo-image"/>
		</a>
		<a class="navbar-brand hidden-lg hidden-md hidden-sm" title="Massengers" href="<?php echo e(url('/')); ?>">
			<img src="<?php echo e(asset('massengers/img/logo.png')); ?>" width="115" alt="Massengers" class="logo-image"/>
		</a>
		<div class="collapse navbar-collapse" id="mess">
			<ul class="nav navbar-nav navbar-left hidden-xs">
				<li class="side-none">
					<a href="<?php echo e(url('/category/need-today')); ?>" title="Need Today" class="new-image">
						<img src="<?php echo e(asset('massengers/img/time.png')); ?>" alt="Need Today"/>
						<p>Need Today</p>
					</a>
				</li>
				<li>
					<a href="<?php echo e(url('/contact-us')); ?>" title="Help" class="new-image">
						<img src="<?php echo e(asset('massengers/img/help.png')); ?>" alt="Help"/>
						<p>Help</p>
					</a>
				</li>
			</ul>
			<ul class="nav navbar-nav navbar-right hidden-xs">
				<li>
					<a href="<?php echo e(url('/track-order')); ?>" title="Track Order" class="new-image">
						<img src="<?php echo e(asset('massengers/img/track.png')); ?>" alt="Track Order"/>
						<p>Track Order</p>
					</a>
				</li>
				<?php if(!Auth::user()): ?>
				<li>
					...
					<a href="<?php echo e(url('/login')); ?>" title="Login/Register" class="new-image">
						<img src="<?php echo e(asset('massengers/img/login.png')); ?>" alt="Login/Register"/>
						<p>Login / Register</p>
					</a>
				</li>
				<?php endif; ?>
				...
				<li class="login-hover">
					...
					<ul class="hover">
						<li><a href="<?php echo e(url('/profile')); ?>" title="View Profile">View Profile</a></li>
						<li><a href="<?php echo e(url('/logout')); ?>" title="Logout">Logout</a></li>
					</ul>
				</li>
				<?php endif; ?>
				<li>
					...
					<a href="<?php echo e(url('/cart')); ?>" title="Check Your Cart" id="" class="new-image">
						<img src="<?php echo e(asset('massengers/img/cart.png')); ?>" alt="Cart"/>
						<p>Cart</p>
						...
						<div id="cart_count_span" class="cart-add"><?php echo e(count($count)); ?></div>
					</a>
				</li>
...
<div class="container center">
	<ul class="nav navbar-nav mob-menu hidden-sm hidden-md hidden-lg">
		...
		<?php if(!Auth::user()): ?>
		<li>
			<a href="<?php echo e(url('/login')); ?>" class="new-image">
				<img src="<?php echo e(asset('massengers/img/login.png')); ?>"/>
				<p>Login / Register</p>
			</a>
		</li>
		...
		<?php if(Auth::user()): ?>
		<li>
			<a href="<?php echo e(url('profile')); ?>" class="new-image">
				<!--<i class="fa fa-user" style="font-size: 35px;color: #D80003;"></i>-->
				<img src="<?php echo e(asset('massengers/img/login-user.png')); ?>" class="after-login"/>
				<p>Hi <?php echo e(substr(Auth::user()->name,0,15)); ?></p> 
			</a>
		</li>
		<?php endif; ?>
...
<div class="container-fluid section1 fixme">
	<div class="container section1-1">
		...
		<div class="service-box">
			<ul>
				<li>
					<a href="<?php echo e(url('/')); ?>" title="Lovers Place">
						<img src="<?php echo e(asset('massengers/img/loversplace.png')); ?>" alt="Lovers Place"/>
						<p>Lovers Place</p>
					</a>
				</li>
				<li>
					<a href="http://blog.massengers.com/" title="Massengers Blog">
						<img src="<?php echo e(asset('massengers/img/lovemantra.png')); ?>" alt="Lovers Mantra"/>
						<p>Lovers Mantra</p>
					</a>
				</li>
				<li>
					<a href="<?php echo e(url('/love-birds')); ?>" title="Love Birds">
						<img src="<?php echo e(asset('massengers/img/love-birds.png')); ?>" alt="Love Birds"/>
						<p>Lovers Birds</p>
					</a>
				</li>
				<li>
					<a href="<?php echo e(url('/love-confession-board')); ?>" title="Confess Your Love">
						<img src="<?php echo e(asset('massengers/img/lcb.png')); ?>" alt="Love Confession Board"/>
...
<div id="mySidenav" class="sidenav">
  <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">&times;</a>
	<br/><br/>
	<form action="<?php echo e(url('/search')); ?>" class="search-bar small-search-bar">
		<input type="text" name="q" placeholder="Search Products"/>
		<button type="submit"><i class="fa fa-search"></i></button>
	</form>
	<a href="<?php echo e(url('/category/need-today')); ?>">
		<i class="fa fa-heart"></i> Same Day
	</a>
	<a href="<?php echo e(url('/category/bithday')); ?>">
		<i class="fa fa-heart"></i> Birthday
	</a>
	<a href="<?php echo e(url('/category/anniversary')); ?>">
		<i class="fa fa-heart"></i> Anniversary
	</a>
	<a href="<?php echo e(url('/category/every-other-day')); ?>">
...
<div id="main">
  ...
  <a href="<?php echo e(url('/love-confession-board')); ?>" class="hidelcb pull-right hidden-sm hidden-lg hidden-md"><img src="<?php echo e(asset('massengers/img/confession-icon.png')); ?>" width="30"><span>Love Confession Board</span></a>
</div>
...
<div class="container-fluid hidden-sm hidden-md hidden-lg" style="padding:0">
    <ul class="slimmenu" id="navigation">
        ...
        <li>
            <a href="<?php echo e(url('/category/'.$categoryLevel1['alias'])); ?>"><i class="fa fa-heart"></i> <?php echo e($categoryLevel1['name']); ?></a>
            <ul>
                <?php foreach($categoryLevel1['childs'] as $categoryLevel2): ?>
                <li>
                    <a href="<?php echo e(url('/category/'.$categoryLevel2['alias'])); ?>"> <?php echo e($categoryLevel2['name']); ?></a>
                    <ul>
                        <?php foreach($categoryLevel2['childs'] as $categoryLevel3): ?>
                            <li><a href="<?php echo e(url('/category/'.$categoryLevel3['alias'])); ?>"><?php echo e($categoryLevel3['name']); ?></a></li>
                        <?php endforeach; ?>
                    </ul>
                </li>
                <?php endforeach; ?>
		...
		<div class="row footer-details">
			...
			<div class="col-md-4 serivces-divs"> 
				<ul class="service-list">
					<li><a href="<?php echo e(url('category/love-letters')); ?>" title="Love Letters">Love Letters</a></li>
					<li><a href="<?php echo e(url('/category/cakes')); ?>" title="Cakes">Cakes</a></li>
					<li><a href="<?php echo e(url('category/home-decorative')); ?>" title="Flower Bouquet">Flower Bouquet</a></li>
					<li><a href="<?php echo e(url('/category/fan-mails')); ?>" title="Fan Mails">Fan Mail</a></li>
					<li><a href="<?php echo e(url('category/parker-pens')); ?>" title="Parker Pens">Parker Pens</a></li>
					<li><a href="<?php echo e(url('/love-confession-board')); ?>" title="Confess Your Love">Love Confession Board</a></li>
					<li class="pdl-60"><a href="<?php echo e(url('/love-birds')); ?>" title="About Us">Love Birds</a></li>
					<li class="pdl-60"><a href="http://blog.massengers.com/" title="Massengers Blog">Love Mantra</a></li>
					<li class="pdl-60"><a href="<?php echo e(url('/track-order')); ?>" title="Track Order">Track Order</a></li>
					<li class="pdl-60"><a href="<?php echo e(url('/career')); ?>" title="Careers">Careers</a></li>
					<li class="pdl-60"><a href="<?php echo e(url('/contact-us')); ?>" title="Contact Us">Contact Us</a></li>
					<!--<li class="pdl-60"><a href="<?php echo e(url('/about-us')); ?>">About Us</a></li>-->
				</ul>
			</div>
			<div class="col-md-4 latest-news">
				...
				<img width="215" alt="Payment Accepted" src="<?php echo e(asset('massengers/img/bank.png')); ?>"/>
			</div>
		</div>
		<div class="row row-footer">
			<center>
				<ul class="footer-terms">
					<li><a href="<?php echo e(url('/terms-and-conditions')); ?>" title="Terms & Conditions">Terms &amp; Conditions</a></li>
					<li><a href="<?php echo e(url('/disclaimer')); ?>" title="Disclaimer">Disclaimer </a></li>
...
<div class="popup-notifier">
	<!--<a href="#" class="popup-close-btn"><img src="<?php echo e(asset('massengers/img/delete-cross.png')); ?>"></a>
...
<script src="<?php echo e(asset('massengers/js/jquery.slimmenu.min.js')); ?>"></script>
...
$(document).ready(function(){
    setInterval(function(){
        $.ajax({
            url: "<?php echo e(url('/getnotificationproducts')); ?>",
            type: "get",
            dataType: 'json',
            success: function(result){
                var image = "<?php echo e(asset('massengers/img/delete-cross.png')); ?>";
                $('.popup-notifier').html('<div class="popup-image"><img src="'+result['image_url']+'" height="50" width="50px;"></div><div class="popup-text"><h6>Someone recently have bought <a href="'+result['url']+'">'+result['product_name']+'</a></h6></div>');
...
<script src="<?php echo e(asset('js/jquery.jscroll.js')); ?>"></script>
