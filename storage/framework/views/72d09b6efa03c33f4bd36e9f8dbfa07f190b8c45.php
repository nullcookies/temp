...
<input type="checkbox" class="billing-save" name="shipping[save_in_address_book]" title="Save in address book" id="set_same_as_billing_address" onclick="set_same_as_billing_address(<?php echo e($buynow->id); ?>,this)">
  <label class="ml-20" for="shipping:save_in_address_book">Same as Billing Address</label>
        <?php echo Form::open(array('id' => 'save_shipping_address_form')); ?>
