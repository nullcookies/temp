			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li>
					<a href="javascript:;" class="new-image">
						...
						<p><?php echo e(substr(Auth::user()->name,0,15)); ?></p>
					</a>
				</li>
				<?php endif; ?>
			</ul>
    ...
    <div class="modal-content">
		...
		<div class="container">
			...
			<div class="row">
			    ...
			    <div class="col-md-6 col-sm-6 col-xs-6">
			        <a href="<?php echo e(route('social.redirect', ['provider' => 'github'])); ?>" class="btn btn-lg waves-effect waves-light btn-block github">GitHub</a>
			    </div>
			</div>
				...
				<!-- <center>
					<ul class="login-social">
						<li>
							<a href="#"><img src="<?php echo e(asset('massengers/img/fb.png')); ?>"/></a>
						</li>
						<br/>
						<li>
							<a href="#"><img src="<?php echo e(asset('massengers/img/googlep.png')); ?>
