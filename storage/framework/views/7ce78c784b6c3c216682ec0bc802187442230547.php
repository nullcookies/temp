...
<div class="container-fluid section4">
	<div class="container">
		...
		<div class="col-md-4 col-sm-4 cat-box">
			<img src="<?php echo e(asset('massengers/img/cat-1.png')); ?>" class="img-responsive"/>
			<ul>
				<li>Love Letters</li>
		...
		<div class="col-md-4 col-sm-4 cat-box">
			<img src="<?php echo e(asset('massengers/img/cat-2.png')); ?>" class="img-responsive"/>
			<ul>
				<li>Fan Mails</li>
				<li class="pull-right"><a href="#">Buy Now <i class="fa fa-chevron-right"></i></a></li>
			</ul>
		...
		<div class="col-md-4 col-sm-4 cat-box">
			<img src="<?php echo e(asset('massengers/img/cat-3.png')); ?>" class="img-responsive"/>
			<ul>
...
<div class="container-fluid section5">
	<div class="container home-brands">
		...
		<div class="owl-carousel owl-theme index-carousel">
            <div class="item">
				<a href="#">
					<img src="<?php echo e(asset('massengers/img/cake1.png')); ?>"/>
...
<div class="container-fluid section6">
	<div class="container">
		...
		<div class="col-md-6 section6-1">
			<span class="flowers">Flowers</span>
			<p>For</p>
			<span class="valentine">Valentine's Day</span>
			<br/>
			<a href="#" class="gift-now" data-toggle="modal" data-target="#formnewsletter">Gift Now</a>
		</div>
	</div>
</div>
	...
	<div class="modal-dialog">
		<div class="modal-content newsletter-content">
			<div class="modal-body text-center">
				...
				<form>
					<input type="text" class="news-input" placeholder="Enter your email"></input>
					<button class="my-button">Subscribe</button>
				</form>
				<h5>We respect your privacy. We will never share or sell your information.</h5>
					<span class="c-red">No Thanks, I want to pay full price.</span>
					<p>T&C apply</p>	
			</div>
		</div>
	</div>
...
<div class="container-fluid section8">
	<div class="container">
		...
		<div class="col-md-6 mr-20 videobox">
			<iframe width="560" height="315" src="https://www.youtube.com/embed/j2MCr7BGmBA" frameborder="0" allowfullscreen></iframe>
		</div>
	</div>
</div>
