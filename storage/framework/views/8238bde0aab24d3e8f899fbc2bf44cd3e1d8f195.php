...
<script src="https://code.jquery.com/jquery-1.12.4.min.js"></script>
  ...
  <script>
      function saveCropImage(object){        
        ...
        var backlink = "<?php echo e($backlink); ?>"; 
        var id = "<?php echo e($id); ?>";  
        var name = "<?php echo e($name); ?>";  
        var designation = "<?php echo e($designation); ?>";  
        ...
        $.ajax({
          ...
          type: 'POST',
          data: {imgdata:imageBase64,id:id,name:name,imagename:imagename,designation:designation,content:content,status:status,path:path,testimonials:1},
          dataType: 'json',
           beforeSend: function (){
  ...
  <div class="row">
      <div class="col-md-9">
        ...
        <div class="img-container">
          <img src="<?php echo url($folder. '/img/',[$img]); ?>" alt="Picture">
        </div>
      </div>
      <div class="col-md-3">
