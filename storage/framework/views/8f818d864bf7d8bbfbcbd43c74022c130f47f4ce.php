	...
	<div class="container">
		...
		<div class="col-md-7">
			<div class="col-md-8 corp-pdt-box">
				<img src="<?php echo e(asset('massengers/img/cake1.png')); ?>" id="myImage"/>
			</div>
			<div class="col-md-4 corp-pdt-img">
				<ul>
					<li>
						<a href="javascript:;" onclick="document.getElementById('myImage').src='massengers/img/cake1.png'"><img src="<?php echo e(asset('massengers/img/cake1.png')); ?>"/></a>
					</li>
					<li>
						<a href="javascript:;" onclick="document.getElementById('myImage').src='massengers/img/cake1.png'"><img src="<?php echo e(asset('massengers/img/cake1.png')); ?>"/></a>
					</li>
