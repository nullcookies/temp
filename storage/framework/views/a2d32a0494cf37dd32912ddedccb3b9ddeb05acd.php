...
<a href="javascript:;" data-toggle="modal" data-target="#myModallcb">
    <img src="<?php echo e(asset('massengers/img/zoozoo.png')); ?>" class="img-responsive">
</a>	
      ...
      <div class="modal-body">
        <form id="love_confession_board_form" class="form-horizontal lcb-form">
				...
				<div class="form-group">
					...
					<div class="col-sm-8">
					<input type="number" name="mobile_number" class="form-control" id="mobile">
					</div>
				</div>
				<div class="form-group"> 
					<center>
...
<?php foreach($confessions as $key => $confession): ?>
<div class="container-fluid pd-40 <?php if($key % 2 != 0): ?> bg-black <?php endif; ?>">
	<div class="container">
		<div class="row row-800 <?php if($key % 2 != 0): ?> c-white <?php endif; ?>">
			<div class="col-md-3">
				<center>
					<img src="<?php echo e(asset('massengers/img/team1.jpg')); ?>" width="150" height="150" class="img-circle" draggable="false"/>
				</center>
			</div>
