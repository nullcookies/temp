	...
	<div class="container">
	    <div class="col-md-9">
	        <div class="row">
        		...
        		<div class="col-md-7 col-sm-8 roboto-light">
        			...
        			<div class="row pd-20 loveletterform <?php if($product->love_letter_options == 'no'): ?> hidden <?php endif; ?>">
                		...
                		<div class="tab-content youmight">
                			...
                			<?php foreach($products as $sameproduct): ?>
                				<div class="col-md-3 text-center">
                					<a href="<?php echo e(url('category/'.$cat_alias.'/product/'.$sameproduct->id)); ?>"><img width="200" src="<?php echo e($productImage[$sameproduct->id]); ?>"/></a>
                    ...
                    <div class="row roboto-light combo-view">
                		...
                		<div class="tab-content youmight">
                			...
                			<div id="combo-<?php echo e($combo->id); ?>" class="tab-pane fade in <?php if($key == 0): ?> active <?php endif; ?> ">
                				...
                				<div class="col-md-3 text-center">
                					<img src="<?php echo e($comboproductImage[$combo->id]); ?>"/>
                					<h5><?php echo e(substr($comboproduct[$combo->id]->product_name, 0, 50)); ?></h5>
                					<h4 class="c-red"><i class="fa fa-inr"></i> <?php echo e($comboproduct[$combo->id]->product_selling_price); ?></h4>
                				</div>
                				<div class="col-md-3 text-center pd-90">
                				<a href="#" class="buy-now-btn"><i class="fa fa-credit-card"></i> Buy Now</a>
                				<br/><br/>
                				<p><i class="fa fa-inr"></i> <?php echo e($comboproduct[$combo->id]->product_selling_price + $product->product_selling_price); ?></p>
                				</div>
                			</div>
                			<?php endforeach; ?>
                    	</div>
    		...
    		<div class="col-md-3 text-center price-section">
    			<h2 class="c-red myriad"><i class="fa fa-inr"></i> <?php echo e($product->product_selling_price); ?></h2>
