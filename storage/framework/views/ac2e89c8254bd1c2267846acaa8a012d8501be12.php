			...
			<tbody>
				<tr>
					<center>
						...
						<img src="http://kibakibi.com/barcode/'<?php echo e($orders->awb_number); ?>" width="100"><br/><?php echo e($orders->awb_number); ?>
                ...
                <tr>
					...
					<!--<td colspan="1" style="text-align: center;" class="forright  sizeheading">-->
						<th colspan="1" style="text-align: center;margin-bottom:10px;font-size:12px;" class="forright  sizeheading">Order no.<br/>
							<img src="http://kibakibi.com/barcode/'<?php echo e($orders->id); ?>" width="100"><br/><p><?php echo e($orders->id); ?></p>
