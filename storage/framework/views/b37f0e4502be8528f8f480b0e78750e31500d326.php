...
<?php $__env->startSection('content'); ?>
		...
		<div class="box box-block bg-white">	
			...
			<h3>Update a new page</h3>			
				...
				<?php endif; ?>
					...
					<li class="demo-tabs"><a href="<?php echo e(route('admin.pages.index')); ?>" class="btn btn-black w-min-sm mb-0-25 waves-effect waves-light">Back</a></li>
					
				</ul>
			</div>
		</div>

		<?php echo Form::open(['id'=>'frmpages', 'files' =>'true','method'=>'PATCH', 'route' => ['admin.pages.update', $item->id]]); ?>
		...
		<div class="col-lg-10 col-md-10">			
				...
				<div class="form-group row">
					...
					<div class="col-xs-8">
						<div id="summernote"><?php echo $item['content']; ?></div>
