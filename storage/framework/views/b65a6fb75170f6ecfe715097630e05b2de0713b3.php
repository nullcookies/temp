        ...
        <div class="block-title"> My Account</div>
          <div class="block-content block-content-my">
            <div class="user-imgbox">
              <img src="<?php echo e(asset('images/user_male.png')); ?>"/>
            </div>
            <div class="user-detailbox">
              <h4><?php echo e(substr(Auth::user()->name,0,20)); ?></h4>
              ...
              <div class="box-content box-category">
                  ...
                  <li> <a class="active" href="javascript:;">Orders</a> <span class="subDropdown minus"></span>
                    <ul class="level0_415" style="display:block">
                      <li> <a href="<?php echo e(url('/user/orders')); ?>"> My Orders </a><!--level1--> </li>
                      <!--level1-->               
                    </ul>
                    <!--level0--> 
                  </li>
              ...
              <div class="box-content box-category">
                  ...
                  <li> <a class="active" href="javascript:;">Profile</a> <span class="subDropdown minus"></span>
                    <ul class="level0_415" style="display:block">
                      ...
                      <li> <a href="<?php echo e(url('/user/addresses')); ?>"> Saved Addresses </a></li>
                      <li> <a href="<?php echo e(url('/user/changePassword')); ?>"> Change Password</a></li>              
                    </ul>
                  </li>
                </ul>
              </div>
