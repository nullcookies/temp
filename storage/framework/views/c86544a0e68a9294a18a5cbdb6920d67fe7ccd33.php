	...
	<div class="container">
		...
		<div class="col-md-5">
			...
			<div class="row">
				...
				<div class="col-md-3 col-xs-4 text-center">
					<img width="70" src="<?php echo e($defaultImage); ?>"/>
					<h5>Small</h5>
					<h4><i class="fa fa-inr"></i> <?php echo e($product->product_selling_price); ?></h4>
				</div>
				<?php endforeach; ?>
			</div>
			<?php endforeach; ?>
		...
		<div class="col-md-3 text-center price-section">
			<h2><i class="fa fa-inr"></i> <?php echo e($product->product_selling_price); ?></h2>
				...
				<input type="number" min="1" value="1" class="delivery-control" name="quantity"  placeholder="Enter required quantity"/><br />				
				...
				<br/>
				<button type="submit" class="buy-now-btn"><i class="fa fa-credit-card"></i> Buy Now</button>
				<br/><br/>
				<a href="javascript:;" id="add_to_cart_btn" class="price-btn"><i class="fa fa-shopping-cart"></i> Add to Cart</a>
			<br/>
