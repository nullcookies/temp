		...
		<div class="box box-block bg-white">	
			...
			<h3><?php echo e($item->tag); ?> </h3>			
				...
				<?php endif; ?>
					...
					<li class="demo-tabs"><a href="<?php echo e(url('admin/product/homepagetag/'.$item->id)); ?>" class="btn btn-black w-min-sm mb-0-25 waves-effect waves-light">Back</a></li>
					
				</ul>
			</div>
		</div>
		<?php echo e(Form::open(['class'=>'form-horizontal company', 'files' =>'true','method'=>'post', 'action'=>['Admin\Product\HomepageTagController@postTagProducts', $item->id]])); ?>

		 
		<div class="col-lg-6 col-md-10">			
			<input type="hidden" name="tagid" value="<?php echo e($item->id); ?>">
				...
				<div class="form-group row">
					...
					<div class="col-xs-8">
						<input class="form-control" type="number" min="1" max="5" name="rating" value="<?php echo e(Old('rating')); ?>">
				...
				<div class="form-group row">
					...
					<div class="col-xs-8">
						<input class="form-control" type="text" name="old_price" value="<?php echo e(Old('old_price')); ?>">
				...
				<div class="form-group row">
					...
					<div class="col-xs-8">
						<input class="form-control" type="text" name="new_price" value="<?php echo e(Old('new_price')); ?>">
				...
				<div class="form-group row">
					...
					<div class="col-xs-8">
						<input class="form-control" type="text" name="link" value="<?php echo e(Old('link')); ?>">
